...
database_redis_nextcloud_password       = "ChangeMeToAStrongPassword123!"
database_redis_onlyoffice_password      = "ChangeMeToAStrongPassword123!"
database_rabbitmq_default_user          = "admin"
database_rabbitmq_default_password      = "ChangeMeToAStrongPassword123!"