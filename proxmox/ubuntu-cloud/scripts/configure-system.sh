...
##  Desc: Configures the system (automatic updates, data directories, firewall)
################################################################################
...
ufw allow 8081/tcp  comment "Vaultwarden"

# Vaultwarden WebSocket notifications
ufw allow 3012/tcp  comment "Vaultwarden WebSocket"
