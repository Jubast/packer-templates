...
vm_name                     = "ubuntu26-database"
vm_id                       = 201

# USER
# user_username             = keypass("ubuntu_database/os_user")
# user_password_encrypted   = keypass("ubuntu_database/os_user_password_encrypted")
# user_ssh_authorized_keys  = keypass("ubuntu_database/os_user_ssh_authorized_keys")
